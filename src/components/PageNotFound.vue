<template>
    <div id="not-found" class="container-fluid page-body-wrapper full-page-wrapper">
            ...
            <div class="row w-100 mx-0">
                <div class="card-body text-center">
                    <div class="stage">
                        ...
                        <button class="btn btn-lg btn-inverse-danger btn-fw" @click="gotoHome">TRỞ LẠI TRANG CHỦ</button>
                        <div class="four">
                            <span>4</span>
                        </div>
                    </div>
